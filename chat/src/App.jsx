...
function App() {
  ...
  return (
    <Router>
      <Routes>
        <Route path="/" element={<ChatList onViewChange={handleViewChange} />} />
          {/* параметр onViewChange передается в ChatList для изменения текущего экрана */}
        <Route path="/chat/:chatId" element={<Chat onViewChange={handleViewChange} />} />
          {/* параметр :chatId передается в Chat для отображения нужного чата */}
      </Routes>
    </Router>
  );
}
